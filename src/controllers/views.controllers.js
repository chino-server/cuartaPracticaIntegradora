import { getProducts, findById, addProduct } from "../services/products.services.js";
import {
  addCartService,
...
export const addViewProductControllers = async (req, res, next)=>{
  try {
